        ...
        <div className="row">
          <div className="col-6 col-md-4">
            ...
            <div className="d-flex align-items-center gap-2 mt-3">
              ...
              {social.snapChat && (
                <a href={social.snapChat} target="_blank" rel="noreferrer">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="25"
                    height="25"
                  ...
                  >
                    <path
                      fill-rule="evenodd"
                      clip-rule="evenodd"
                      d="M17.8103 0C15.0255 0 12.3548 1.10625 10.3857 3.07538C8.41654 5.04451 7.3103 7.71523 7.3103 10.5V13.7812L5.7353 12.6C5.55144 12.4621 5.34224 12.3618 5.11961 12.3048C4.89699 12.2477 4.66531 12.2351 4.43781 12.2676C4.2103 12.3001 3.99143 12.3771 3.79368 12.4942C3.59593 12.6113 3.42318 12.7661 3.2853 12.95C3.14741 13.1339 3.04708 13.3431 2.99005 13.5657C2.93301 13.7883 2.92038 14.02 2.95288 14.2475C2.98538 14.475 3.06238 14.6939 3.17946 14.8916C3.29655 15.0894 3.45144 15.2621 3.6353 15.4L6.90079 17.85C6.1238 19.894 4.22855 22.0325 1.1608 23.8752C0.959576 23.9988 0.785139 24.1613 0.647782 24.3533C0.510425 24.5454 0.412932 24.763 0.361059 24.9933C0.309186 25.2236 0.303985 25.462 0.345761 25.6944C0.387538 25.9268 0.475445 26.1484 0.604295 26.3463C2.5608 29.281 5.6653 31.5 9.0603 31.5C12.1823 31.5 14.3225 35 17.8103 35C21.3295 35 23.426 31.5 26.5603 31.5C29.9553 31.5 33.0598 29.281 35.0163 26.3463C35.1451 26.1484 35.2331 25.9268 35.2748 25.6944C35.3166 25.462 35.3114 25.2236 35.2595 24.9933C35.2077 24.763 35.1102 24.5454 34.9728 24.3533C34.8355 24.1613 34.661 23.9988 34.4598 23.8752C31.392 22.0325 29.4968 19.894 28.7198 17.85L31.9853 15.4C32.3566 15.1215 32.6021 14.707 32.6677 14.2475C32.7333 13.788 32.6138 13.3213 32.3353 12.95C32.0568 12.5787 31.6423 12.3332 31.1828 12.2676C30.7233 12.202 30.2566 12.3215 29.8853 12.6L28.3103 13.7812V10.5C28.3103 7.71523 27.2041 5.04451 25.2349 3.07538C23.2658 1.10625 20.5951 0 17.8103 0Z"
                      fill="#28348A"
                    />
                  </svg>
                </a>
              ...
              {social.tiktok && (
                <a href={social.tiktok} target="_blank" rel="noreferrer">
                  ...
                  >
                    <path
                      d="M24.2475 5.48333C22.9183 3.96593 22.1858 2.01723 22.1864 0H16.178V24.1111C16.1317 25.4159 15.5808 26.6518 14.6415 27.5585C13.7021 28.4652 12.4475 28.972 11.1419 28.9722C8.38082 28.9722 6.08637 26.7167 6.08637 23.9167C6.08637 20.5722 9.31415 18.0639 12.6391 19.0944V12.95C5.93082 12.0556 0.0585938 17.2667 0.0585938 23.9167C0.0585938 30.3917 5.42526 35 11.1225 35C17.228 35 22.1864 30.0417 22.1864 23.9167V11.6861C24.6228 13.4358 27.5479 14.3746 30.5475 14.3694V8.36111C30.5475 8.36111 26.8919 8.53611 24.2475 5.48333Z"
                      fill="#28348A"
                    />
                  </svg>
                </a>
              ...
              {social.herag && (
                <a href={social.herag} target="_blank" rel="noreferrer">
          ...
          <div className="col-6 col-md-4">
            <p className={`m-0 p-0 mb-5 ${style.title}`}>{t("contact")}</p>
            ...
            <div className="d-flex  gap-1 mb-1">
              ...
              <span className={`d-inline-block ${style.link} ${style.map}`}>
                {social.address}
              </span>
            </div>
            <div className="mt-3 d-md-none">
              <p className={`m-0 p-0 mb-2 ${style.title}`}>{t("pages")}</p>
              <ul className="m-0 p-0 ">
                {links.map((item, index) => (
                  <li key={index} className="mb-2">
                    <Link className={style.pageLink} to={item.path}>
          ...
          <div className="d-none d-md-block col-md-4">
            <p className={`m-0 p-0 mb-5 ${style.title}`}>{t("pages")}</p>
            <ul className="m-0 p-0">
              {links.map((item, index) => (
                <li key={index} className="mb-2">
                  <Link className={style.pageLink} to={item.path}>
